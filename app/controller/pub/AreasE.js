Ext.define("Siace.controller.pub.AreasE",{extend:"Ext.app.Controller",stores:["array.DocOrden","array.Years"],views:["pub.AreasE"],
...
pae_BS:function(comp,opt){var _TE=comp.getTE();var _frm=comp.down("form");var _cboLK=comp.down("#loc_key");var _cboPK=comp.down("#parent_key");var _me=this;
	if(_TE==1){var _ico="icon_New_90";var _tit="Nuevo Registro de Documento ::.";this.pae_LP(comp,"","",false);}
