Ext.define("Siace.controller.log.FaseAcceE03",{extend:"Ext.app.Controller",
lfa:function(poC){poC.setIconCls("icon_Query_90");poC.setTitle("Consulta Fase de Acceso ::.");var _frm=poC.down("form");fext_Dsb(poC,"doc_id");
	...
	fext_Dsb(comp,"",["area_key","doc_id","fase_id","cargusur_id","faseacce_type","fase_next","faseacce_vobo","faseacce_estado","faseacce_observ","btnSave","btnUndo"]);comp.down("#btnExit").enable();
}
});