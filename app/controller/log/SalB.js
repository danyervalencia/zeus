Ext.define("Siace.controller.log.SalB",{extend:"Ext.app.Controller",
lsb_sc:function(mod,r){if(r.length==1){var _pan=mod.view.up("log_salb");var _p=_pan.down("#pan");var _fg=r[0].data.sal_flga==98?true:"";var _del=(_pan.getMI()==5135&&!Ext.isEmpty(r[0].data.sal_fechasal)?false:true);
