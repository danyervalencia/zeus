Ext.define("Siace.controller.log.SalidasBN",{extend:"Ext.app.Controller",stores:["array.Years"],views:["log.SalidasBN"],
init:function(application){this.control({
"log_salbn":{beforerender:this.lsb_BR},"log_salbn #pan #opc_id":{change:this.lsb_pls_oiChg},"log_salbn #pan #btnNew":{click:this.lsb_pan_btn},"log_salbn #pan #btnModify":{click:this.lsb_pan_btn},"log_salbn #pan #btnQuery":{click:this.lsb_pan_btn},"log_salbn #pan #btnAnnular":{click:this.lsb_pan_btn},"log_salbn #pan #btnPrinter":{click:this.lsb_pan_btn},
"log_salbn #pan #area_key":{change:this.lsb_pls_ChgCbo},"log_salbn #pan #fechaini":{change:this.lsb_pls_Chg},"log_salbn #pan #fechafin":{change:this.lsb_pls_Chg},
"log_salbn #pan #grdLS":{cellclick:this.lsb_pls_grdCellClk,selectionchange:this.lsb_pls_grdSelChg},
"log_salbn #pan #sal_nro":{change:this.lsb_pls_Chg,keypress:this.lsb_pls_KP},"log_salbn #pan #meta_id":{change:this.lsb_pls_ChgCbo},"log_salbn #pan #tarea_key":{change:this.lsb_pls_ChgCbo},"log_salbn #pan #year_id":{change:this.lsb_pls_ChgCbo}
});},
lsb_BR:function(comp,opt){var _mi=comp.getMI();var _pan=comp.down("#pan");var _grd=_pan.down("#grdLS");var _t1=comp.down("#tabLSD");var _vs=fextpub_sessVar();var _me=this;
	...
	if(_mi==5136){fextbud_metasParam({pan:_pan});fextbud_tareasParam({pan:_pan});fextpub_yearsVisible(_pan.down("#year_id"),_vs.y);fextpub_areasFilt({obj:_pan.down("#area_key"),filt:false,nuk:"NoT"});}else{return false;}
...
lsb_pan_btn:function(btn,e,opt){fext_CC("log.SalBNB").lsb(btn,opt);},
lsb_pls_grdCellClk:function(cell,td,cellI,r,tr,rowI,e,o){fext_TL(cell.up("log_salbn"));},
lsb_pls_grdSelChg:function(mod,r,o){fext_CC("log.SalBN").lsb_sc(mod,r);},
});