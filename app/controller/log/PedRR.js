Ext.define("Siace.controller.log.PedRR",{extend:"Ext.app.Controller",
lpr:function(btn){var _p=btn.up("#pan");var _pan=_p.up("log_pedr");var _TE=(fext_btnTE(btn)=="Pdf"?32:33);var _vs=fextpub_sessVar();
	...
	var _tpi=fext_GV(_p,"tipped_id")*1;var _ci=fext_GV(_p,"categ_id")*1;var _filter=fext_GV(_p,"filter");var _fi=fext_GV(_p,"fase_id")*1;
	...
	var _uck=fext_GV(_p,"usuracce_key");var _ucn=_p.down("#usuracce_key").getRawValue(); 
