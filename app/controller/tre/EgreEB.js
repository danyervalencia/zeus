Ext.define("Siace.controller.tre.EgreEB",{extend:"Ext.app.Controller",
tee:function(btn){var _w=btn.up("window");var _TE=fext_btnTE(btn);
	if(_TE==5){fext_CC("tre.EgreES").tees(_w);}
