Ext.define("Siace.view.tre.EgresosOK",{extend:"Siace.view.WindowOk",alias:"widget.tre_egreok",width:250,items:[
{xtype:"form",border:false,layout:"vbox",items:[
{xtype:"container",layout:"vbox",margin:"15 0 5 0",width:"100%",items:[{xtype:"hiddenfield",itemId:"egre_document"},
