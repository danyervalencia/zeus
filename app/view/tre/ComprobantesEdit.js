Ext.define('Siace.view.treasury.ComprobantesEdit', {
	extend: 'Siace.view.WindowEdit',
	alias: 'widget.treasury_comprobantesedit',
	width: 750,
			...
			items: [
					...
					items : [
				        {	
			                ...
			                store: {
			                    ...
			                    data: [ { doc_id: 401, doc_nombre: 'Comprobante de Ingreso' } ]
			                },				        	
				        	disabled: true, fieldLabel: translations.documento, labelWidth: 70, margin: '0 4 5 0', value: 401, width: 230, 
				       	},
				...
				},
				{
					...
					items : [
					    ...
					    //{	xtype: 'component_combotop', itemId: 'pctbl_idx', valueField: 'pctbl_cuenta', displayField: 'pctbl_cuenta', disabled: true, hidden: true },
			        ]
			    },
				{
					xtype : 'container', layout: 'hbox', width: '100%',
