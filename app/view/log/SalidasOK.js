Ext.define("Siace.view.log.SalidasOK",{extend:"Siace.view.WindowOk",alias:"widget.log_salok",width:250,items:[
{xtype:"form",border:false,layout:"vbox",items:[
{xtype:"container",layout:"vbox",margin:"15 0 5 0",width:"100%",items:[
	{xtype:"hiddenfield",itemId:"doc_abrev",disabled:true},{xtype:"hiddenfield",itemId:"sal_documento",disabled:true},
	...
	{xtype:"label",itemId:"sal_document",margin:"15 0 20 0",width:"100%",style:{color:"#990000",fontFamily:"arial narrow",fontSize:"15px",fontWeight:"bold",textAlign:"center"}}
]}
]}]});