Ext.define('Siace.view.log.Cuadro_NecesidadesRep',{extend:'Siace.view.PanelBrowse',alias:'widget.log_cuanecrep',layout:{type:'hbox'},items:[
{xtype:'panel',itemId:'panLCN',defaults:{labelWidth:70,width:"100%"},border:false,height:'100%',layout:'vbox',padding:'10 10',width:550,items:[
