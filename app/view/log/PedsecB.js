Ext.define("Siace.view.log.PedsecB",{extend:"Siace.view.PanelBrowse",alias:["widget.log_pedsecb"],layout:{type:"hbox"},items:[
{xtype:"panb1",title:"Módulo Env./Rec. de Requerimientos ::.",width:"60%",items:[
	{xtype:"comp_grid",itemId:"grd",viewConfig:{getRowClass:function(r,rowI,rowP,str){return r.data.rcol}},
	 columns:[{xtype:"rownumberer",width:30},{dataIndex:"tiptram_abrev",text:"Tipo",width:60},{dataIndex:"pedsec_datetime",align:"center",text:"Fecha/Hora",width:95,renderer:function(val,metaD,rec,rowI,colI,str,view){return rec.data.pedsec_feho;}},
		{dataIndex:"ped_documento",text:"Registro",width:70},{dataIndex:"pedtram_documento",align:"center",text:"Tramite",width:65},{dataIndex:"area_abrev",text:"U.O.",width:60},{dataIndex:"usur_login",text:"Usuario",width:120},
	    {dataIndex:"tarea_codigo",text:"Tarea",align:"center",width:70},{dataIndex:"fftr_codigo",text:"Rb-TR",width:45},{dataIndex:"ped_monto",text:"Importe",align:"right",renderer:fext_FN(2),lockable:false,sortable:true,width:90}
	]}
 ],
 dockedItems:[{xtype:"comp_cboopc"},
	...
	{xtype:"comp_toolbtn",items:[{xtype:"comp_btnQuery",text:""},{xtype:"comp_btn",itemId:"btnDet",disabled:true,icon:"resources/icons/btnEttr.png",text:""},{xtype:"comp_btnAttach",text:""},{xtype:"comp_btn",itemId:"btnSub",disabled:true,icon:"resources/icons/user_go.png",text:"Enviar"},{xtype:"comp_btn",itemId:"btnRec",disabled:true,icon:"resources/icons/user_rec.png",text:"Recibir"}]},{xtype:"comp_pag",itemId:"pag"}
]},
{xtype:"tpnb1",items:[
