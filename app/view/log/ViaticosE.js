Ext.define("Siace.view.log.ViaticosE",{extend:"Siace.view.WinE",alias:["widget.log_viate"],requires:["Siace.view.comp.rrhh.TrabjS"],width:650,items:[{xtype:"form",bodyPadding:8,border:true,items:[
...
{xtype:"tabpanel",activeTab:0,plain:true,width:"100%",items:[
	...
	{xtype:"panel",itemId:"tabDDET",bodyPadding:4,title:"Detalle de Viáticos",width:"100%",items:[
		{xtype:"comp_grid",itemId:"grdLVD",height:140,columns:[{xtype:"rownumberer",width:30},{dataIndex:"bs_codigo",text:"Código",sortable:false,width:105},{dataIndex:"bs_nombre",text:"Descripción",sortable:false,width:365},
			{dataIndex:"viatdet_pretot",text:"Importe",align:"right",renderer:fext_FN(2),sortable:false,width:90,editor:{xtype:"comp_number",allowBlank:false,decimalPrecision:2,maxLength:9,maxValue:99999,value:""}},{dataIndex:"viatdet_pretot",text:"Importe",align:"right",hidden:true,renderer:fext_FN(2),sortable:false,width:90},{dataIndex:"viatdet_rendido",text:"Rendición",align:"right",hidden:true,renderer:fext_FN(2),sortable:false,width:90,editor:{xtype:"comp_number",decimalPrecision:2,maxLength:9,maxValue:99999,value:""}},
		...
		{xtype:"container",margin:"3 0 0 0",layout:"hbox",width:"100%",items:[{xtype:"button",itemId:"btnAdd",text:"Agregar",disabled:true,iconCls:"icon_Add",padding:"2 6 2 8"},{xtype:"button",itemId:"btnModify",text:"Editar",disabled:true,iconCls:"icon_Modify",margin:"0 5",padding:"2 6 2 8"},{xtype:"button",itemId:"btnSuppress",text:"Suprimir",disabled:true,iconCls:"icon_Suppress",padding:"2 6 2 8"},{xtype:"displayfield",flex:1},{xtype:"comp_curr",itemId:"viat_monto",name:"viat_monto",disabled:true,fieldLabel:"Importe",labelWidth:50,value:0,width:140},{xtype:"comp_curr",itemId:"viat_rendido",disabled:true,hidden:true,value:0,width:90},{xtype:"displayfield",width:20}]}
	]},
