Ext.define("Siace.view.log.SalidasB",{extend:"Siace.view.PanB",alias:["widget.log_salb"],items:[
{xtype:"panb1",title:"Módulo Salida de Bienes ::.",width:"60%",items:[
	{xtype:"comp_grid",itemId:"grdLS",viewConfig:{getRowClass:function(r,rowI,rowP,str){return r.data.rcol;}},
	 columns:[{xtype:"rownumberer",width:30},{dataIndex:"sal_documento",text:"Documento",width:80},{dataIndex:"sal_fecha",text:"Fecha",align:"center",renderer:fext_FD(),width:80},{dataIndex:"tablex_documento",text:"Procedencia",width:100},{dataIndex:"area_abrev",text:"U.O.",width:60},{dataIndex:"tarea_codigo",text:"Tarea",align:"center",width:70},{dataIndex:"fftr_codigo",text:"Rb-TR",width:45},{dataIndex:"indiv_apenom",text:"Responsable",width:250},{dataIndex:"tipprocreg_abrev",text:"Tipo",width:40},{dataIndex:"sal_monto",text:"Importe",align:"right",renderer:fext_FN(2),width:90}]}
 ],
