Ext.define("Siace.view.log.ViaticosOK",{extend:"Siace.view.WindowOk",alias:"widget.log_viatok",width:250,items:[{xtype:"form",border:false,layout:"vbox",items:[
{xtype:"container",layout:"vbox",margin:"15 0 5 0",width:"100%",items:[
	...
	{xtype:"label",itemId:"viat_documento",margin:"15 0 20 0",width:"100%",style:{color:"#990000",fontFamily:"Arial Narrow",fontSize:"15px",fontWeight:"bold",textAlign:"center"}}
]}]}]});