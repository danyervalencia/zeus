Ext.define("Siace.view.WindowOk",{extend:"Ext.window.Window",alias:"widget.windowok",closable:false,layout:{type:"fit"},modal:true,resizable:false,buttons:{buttonAlign:"left",items:[{xtype:"comp_btnNew"},{xtype:"comp_btnPrinter",disabled:true},{xtype:"comp_btnExit",disabled:false}]},__cc:null,__cb:null,__ck:"",__cs:null,__mi:"",__TE:"",
