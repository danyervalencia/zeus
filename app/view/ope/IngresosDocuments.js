Ext.define('Siace.view.operations.IngresosDocuments', {
	extend: 'Siace.view.WindowBrowse',
	alias: 'widget.operations_ingresosdocuments',
	closable: true, height: 300, width: 400,

	items: [
		{
			xtype: 'form', itemId: 'frmOperations_ingresos',
			border: false, layout: { type: 'fit' },
			items: [
				{
					xtype: 'grid', itemId: 'grdOperations_ingresos_documentos',
					...
					columns: [
						...
						{
							xtype: 'actioncolumn', itemId: 'acOperations_ingresos_documentos', align: 'center', width: 30,
							items: [
								{
