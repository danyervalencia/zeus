 Ext.define('Siace.view.operations.IngresosReports', {
	extend: 'Siace.view.PanelBrowse',
	alias: 'widget.operations_ingresosreports',

    items: [
	    {
	        xtype: 'toolbar', dock: 'top', layout: 'vbox', padding: '10 10', ui: 'footer', defaults: { labelWidth: 75 },
	        items: [
	            { 	xtype: 'component_combo', itemId: 'type_record', valueField: 'typrec_id', displayField: 'typrec_nombre', tpl:'<tpl for="."><div class="x-boundlist-item">{typrec_nombre}&nbsp;</div></tpl>', fieldLabel: translations.reporte, margin: '0 0 5 0', width: 350, },
	            ...
	            {	xtype: 'component_combo', itemId: 'tipmov_id', valueField: 'tipmov_id', displayField: 'tipmov_nombre', tpl:'<tpl for="."><div class="x-boundlist-item">{tipmov_nombre}&nbsp;</div></tpl>', fieldLabel: translations.procedencia, margin: '0 0 5 0', width: 284, },
				{
